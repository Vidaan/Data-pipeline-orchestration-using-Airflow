...
# setting up a python function to get the data that was gathered in extract_user into JSON 
# and then convert it into CSV
...
# Creating a function that takes the data in a csv file and loads it into the Postgres table
def _store_user():
